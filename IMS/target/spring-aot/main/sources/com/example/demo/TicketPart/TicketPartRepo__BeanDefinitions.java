...
/**
 * Bean definitions for {@link TicketPartRepo}.
 */
@Generated
public class TicketPartRepo__BeanDefinitions {
  /**
   * Get the bean instance supplier for 'ticketPartRepo'.
   */
  private static BeanInstanceSupplier<JpaRepositoryFactoryBean> getTicketPartRepoInstanceSupplier(
      ) {
  ...
  /**
   * Get the bean definition for 'ticketPartRepo'.
   */
  public static BeanDefinition getTicketPartRepoBeanDefinition() {
    RootBeanDefinition beanDefinition = new RootBeanDefinition(JpaRepositoryFactoryBean.class);
    beanDefinition.setTargetType(ResolvableType.forClassWithGenerics(JpaRepositoryFactoryBean.class, TicketPartRepo.class, TicketPart.class, Long.class));
    beanDefinition.setLazyInit(false);
    beanDefinition.getConstructorArgumentValues().addIndexedArgumentValue(0, "com.example.demo.TicketPart.TicketPartRepo");
    ...
    beanDefinition.getPropertyValues().addPropertyValue("repositoryFragments", new RuntimeBeanReference("jpa.TicketPartRepo.fragments#0"));
    ...
    beanDefinition.getPropertyValues().addPropertyValue("repositoryFragmentsFunction", new RepositoryFactoryBeanSupport.RepositoryFragmentsFunction() {
      public RepositoryComposition.RepositoryFragments getRepositoryFragments(
        ...
        return RepositoryComposition.RepositoryFragments.just(new com.example.demo.TicketPart.TicketPartRepoImpl__AotRepository(entityManager, context));
      }
    });
    InstanceSupplier<JpaRepositoryFactoryBean> instanceSupplier = getTicketPartRepoInstanceSupplier();
