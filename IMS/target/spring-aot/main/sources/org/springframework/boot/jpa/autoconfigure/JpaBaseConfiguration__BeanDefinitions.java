...
public class JpaBaseConfiguration__BeanDefinitions {
  ...
  public static class PersistenceManagedTypesConfiguration {
    ...
    private static PersistenceManagedTypes getPersistenceManagedTypesInstance() {
      List<String> managedClassNames = List.of("com.example.demo.TicketPart.TicketPart", "com.example.demo.audit.Audit", "com.example.demo.parts.Parts", "com.example.demo.ticket.Ticket", "com.example.demo.user.User");
